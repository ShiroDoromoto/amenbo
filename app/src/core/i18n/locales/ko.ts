...
export const ko: Translation = {
  ...
  ui: {
    ...
    "auto.lib.device": "이 기기 (어느 프로젝트에서나 배치할 수 있음)",
    ...
    "auto.step.nextExit": "이 액션에서 나가기: {name}",
    "auto.pic.actionIn": "이 액션으로 들어옴",
    "auto.pic.actionOut": "이 액션의 종료 조건",
    ...
    "auto.act.declares": "이 액션이 선언하는 것",
