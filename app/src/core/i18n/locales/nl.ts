...
export const nl: Translation = {
  ...
  ui: {
    ...
    "settings.automation": "Automatiseringen",
    "settings.lanes": "Banen",
    "settings.lanesNote": "Hoeveel automatiseringsruns tegelijk kunnen lopen. Eén baan is één terminal die je in de gaten houdt, en het aantal geldt over projecten heen. Verlagen stopt niets wat al loopt — de volgende start wacht langer op een baan.",
    ...
    "face.lanesHeld": "Automatiseringsbanen: {held} van {lanes} in gebruik",
    "face.pages": "Pagina's",
    "face.page": "Pagina {n}",
    ...
    "auto.block.openExit": "{step}: na {at} staat niets vast.",
    "auto.block.openExitUnnamed": "{step}: daarna staat niets vast.",
    ...
    "auto.pic.fromAction": "uit {action}",
    "auto.pic.unfed": "er bereikt niets {names}",
    "auto.pic.hands": "geeft {from} door aan {to}",
    "auto.step.none": "Druk op een stap in de tekening om te zien wat erin zit.",
    "auto.step.name": "Naam",
    "auto.step.task": "De taak waar het over gaat",
    "auto.step.takesTask": "Hier pakt hij de volgende taak",
    "auto.step.carriesTask": "Hij werkt aan de taak die een eerdere stap pakte",
    "auto.step.source": "Wat hij uitvoert",
    "auto.step.sourceOwn": "Een hier geschreven prompt",
    "auto.step.sourceMoves": "Omschakelen neemt de uitgangen, instellingen en invoer van deze stap mee.",
    "auto.step.prompt": "Prompt",
    "auto.step.promptFromAction": "Alleen lezen — komt uit {action}. Herschrijf hem op het tabblad acties.",
    "auto.step.raise": "In de bibliotheek zetten",
    "auto.step.raiseWhat": "De stap draait daarna de versie uit de bibliotheek, en zijn uitgangen, instellingen en invoer gaan mee.",
    "auto.step.raiseName": "Hoe het in de bibliotheek heet",
    "auto.step.raiseHere": "Alleen dit project",
    "auto.step.raiseEverywhere": "Alle projecten op deze computer",
    ...
    "auto.add.title": "Een stap invoegen",
  ...
  err: {
    ...
    not_ready_automation_no_steps: "Het heeft geen enkele stap",
    not_ready_automation_no_entry: "Geen enkele stap is aangewezen als de stap waar een run begint",
