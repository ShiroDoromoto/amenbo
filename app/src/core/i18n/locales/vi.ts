...
export const vi: Translation = {
  ...
  ui: {
    ...
    "search.filterPhNone": "Loại này không nhận bộ lọc",
    "search.kind": "Loại",
    "search.kindAll": "Tất cả",
    "search.kind.task": "Việc",
    "search.kind.decision": "Quyết định",
    "search.kind.automation": "Tự động hoá",
    ...
    "search.on.automation": "Tự động hoá",
    ...
    "auto.act.noEntry": "Chưa định bước nào mở đầu tiên. Hãy chọn một bước bên dưới.",
