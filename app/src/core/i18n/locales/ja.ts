...
export const ja: Translation = {
  ...
  ui: {
    ...
    "auto.new.make": "作る",
    "auto.new.cancel": "取消",
    "auto.newFirst": "最初のオートメーションを作る",
    "auto.archivedFold": "アーカイブ {count}",
    ...
    "auto.place.open": "アクションを開く",
    "auto.place.empty": "中身がまだ空です。組み終えるまで起動できません",
    "auto.place.agents": "実行する AI",
    "auto.place.agentNone": "選んでいない",
    ...
    "auto.hand.taskTitle": "起票するタスクのタイトル",
    "auto.hand.taskNotes": "本文",
    "auto.hand.required": "必須",
    ...
    "auto.step.nextGoBack": "{name} を開く（戻る）",
    "auto.step.nextGroupPlacement": "次の配置を開く",
    "auto.step.nextGroupStep": "ステップを開く",
    "auto.step.nextGroupExit": "このアクションの出口で終える",
    "auto.step.nextGroupEnd": "ここで終わる",
    "auto.step.placementRemove": "この配置を消す",
    "auto.step.placementRemoveConfirm": "この配置を消します。答えた設定と、この配置を指す線も一緒に消えます。アクションそのものはライブラリに残ります。戻せません",
    "auto.step.task": "扱っているタスク",
    "auto.step.takesTask": "ここで次のタスクを取る",
    "auto.step.prompt": "プロンプト",
    "auto.decl.add": "＋ 足す",
    "auto.decl.required": "● 必須",
    "auto.decl.more": "直す・消す",
    "auto.decl.outputAdd": "渡すものを足す",
    "auto.decl.inputs": "受け取るもの",
    "auto.decl.inputName": "受け取るものの名前",
    "auto.decl.answeredOnPlacement": "配置で答える",
    "auto.give.title": "AI に渡すもの",
    "auto.give.history": "ここまでの歩み",
    "auto.give.taskNotes": "タスクの本文",
    "auto.give.taskDecisions": "リンクした決定",
    "auto.give.taskComments": "コメント",
    "auto.step.howRuns": "動かし方",
    "auto.act.entrySwitch": "このステップを起点にする",
    "auto.act.nameOf": "{place}の名前",
    "auto.actions.notePlaceholder": "一覧に出る一言",
    "auto.act.placedOn": "置いているオートメーション",
    "auto.step.interactive": "人の返事を待ってよい",
    "auto.step.folderNone": "ペインと同じ場所",
    "auto.step.cfg": "設定",
    ...
    "auto.step.ready": "前提",
    "auto.step.readyYes": "着手できる",
    "auto.step.readyNo": "着手できない",
    "auto.step.sortTake": "{sort} に並べて、いちばん上の1件を取る",
    "auto.step.sort.priority": "優先度の高い順",
    "auto.step.sort.due": "期限の近い順",
    "auto.step.sort.created": "古い順",
    "auto.kind.value": "値",
    "auto.kind.file": "ファイル",
    ...
    "auto.actions.reachBuiltin": "組み込み",
    "auto.bi.takeTask.name": "タスクに着手する",
    ...
    "auto.bi.takeTask.task": "タスク",
    "auto.bi.makeTask.name": "タスクを起票する",
    "auto.bi.makeTask.does": "受け取ったタイトルと本文で、タスクを1件起票する。設定で、起票と同時に進行中にし、この run で扱える",
    "auto.bi.makeTask.whatThen": "起票したタスク",
    "auto.bi.makeTask.leaveIt": "未着手のまま、出口「起票した」へ進む",
    "auto.bi.makeTask.takeIt": "進行中にして、出口「起票して着手した」へ進む",
    "auto.bi.makeTask.dependsOn": "依存させる相手",
    "auto.bi.makeTask.theRunsTask": "この run が扱っているタスク",
    "auto.bi.makeTask.classify": "分類",
    "auto.bi.makeTask.aiAxes": "AI に選ばせる軸",
    "auto.bi.makeTask.assignee": "担当",
    "auto.bi.makeTask.priority": "優先度",
    "auto.bi.makeTask.none": "なし",
    "auto.bi.makeTask.human": "人",
    "auto.bi.makeTask.ai": "AI",
    "auto.bi.makeTask.high": "高",
    "auto.bi.makeTask.medium": "中",
    "auto.bi.makeTask.low": "低",
    "auto.bi.makeTask.title": "タイトル",
    "auto.bi.makeTask.notes": "本文",
    "auto.bi.makeTask.chosen": "選んだ分類",
    "auto.bi.makeTask.made": "起票した",
    "auto.bi.makeTask.madeAndTaken": "起票して着手した",
    "auto.bi.makeTask.task": "タスク",
    "auto.bi.makeTask.dependsOnTasks": "依存させる既存のタスク",
    "auto.bi.makeTask.decisions": "リンクする決定",
    "auto.bi.makeTask.folder": "作業フォルダ",
    "auto.bi.cutWorktree.name": "worktree を切る",
    "auto.bi.cutWorktree.does": "いま扱っているタスクの worktree を、リモートの既定ブランチの最新から切り、そのパスを渡す",
    "auto.bi.cutWorktree.worktree": "worktree",
    "auto.bi.cutWorktree.done": "完了",
    "auto.bi.foldWorktree.name": "worktree を畳む",
    "auto.bi.foldWorktree.does": "いま扱っているタスクの worktree とブランチを片付ける。リモートの既定ブランチにまだ入っていない変更があれば、畳まずに「未マージ」から出る",
    "auto.bi.foldWorktree.unmerged": "未マージ",
    "auto.bi.foldWorktree.done": "完了",
    "auto.bi.closeTask.name": "タスクを閉じる",
    "auto.bi.closeTask.does": "いま扱っているタスクを完了にする。コミットを受け取ったら、その SHA も記録する",
    "auto.bi.closeTask.commit": "コミット",
    "auto.bi.closeTask.done": "完了",
    "auto.bi.fetch.name": "取りに行く",
    "auto.bi.fetch.does": "設定した先（URL・ファイルパス・コマンド）を見に行き、取ってきた中身を渡す。何も無ければ「見つからない」から出る",
    "auto.bi.fetch.form": "形式",
    "auto.bi.fetch.url": "URL",
    "auto.bi.fetch.filePath": "ファイルパス",
    "auto.bi.fetch.command": "コマンド",
    "auto.bi.fetch.target": "見に行く先",
    "auto.bi.fetch.fetched": "取ってきた",
    "auto.bi.fetch.content": "中身",
    "auto.bi.fetch.notFound": "見つからない",
    "auto.bi.splitByDim.name": "分類で分ける",
    "auto.bi.splitByDim.does": "いま扱っているタスクを、選んだ軸の値で分ける。値ごとに出口があり、値が付いていないタスクは「分類なし」から出る",
    "auto.bi.splitByDim.unsorted": "分類なし",
    "auto.bi.wait.name": "待つ",
    "auto.bi.wait.does": "設定した時間だけ待ってから、「完了」から出る",
    "auto.bi.wait.hours": "時間",
    "auto.bi.wait.minutes": "分",
    "auto.bi.wait.seconds": "秒",
    "auto.bi.wait.done": "完了",
    "auto.actions.unused": "未使用",
    "auto.actions.usedBy.other": "{n}本で使用",
    "auto.actions.name": "名前",
    "auto.actions.note": "メモ",
    "auto.actions.cancel": "取消",
    "auto.actions.make": "作る",
    "auto.actions.makeOpen": "作って開く",
    "auto.actions.makeFirst": "最初のアクションを作る",
    "auto.actions.stepsEmpty": "空",
    "auto.actions.more": "その他の操作",
    "auto.actions.remove": "消す",
    "auto.builtin.back": "戻る",
    "auto.act.aboutPlace": "アクション",
    "auto.act.edit": "編集",
    "auto.act.openInSidebar": "サイドバーで開いて直す ↗",
    "auto.held.by": "実行 #{run} が使用中",
    "auto.held.openPane": "ペインを開く",
    "auto.act.stepsPlace": "ステップ",
    "auto.step.nextExit": "出口「{name}」で終える",
    "auto.pic.actionIn": "受け取る",
    ...
    "auto.act.addTitle": "ステップを足す",
    "auto.act.insertTitle": "ステップを挟む",
    "auto.act.addPut": "足す",
    "auto.act.insertPut": "挟む",
    "auto.act.firstStep": "＋ 最初のステップ",
    "auto.act.stepAdd": "＋ ステップ",
    "auto.act.stepRemove": "このステップを消す",
    "auto.act.stepRemoveConfirm": "このステップを消しますか？ 入力パラメータと出口、このステップを指す線も一緒に消えます。元に戻せません",
    "auto.about.name": "名前",
    "auto.about.notes": "メモ",
    "auto.about.cli": "CLI",
    "auto.about.copy": "コピー",
    ...
    "auto.run.maxTimes": "上限を超えた",
    "auto.run.noAgent": "エージェントを起動できなかった",
    "auto.run.noWayOn": "次に開くステップが無い",
    "auto.run.noInput": "必須の入力が空",
    "auto.run.halted": "人を呼ぶ出口で止まった",
    "auto.run.leftTaskOpen": "タスクを閉じずに次へ進もうとした",
    "auto.say.crashed": "オートメーションの実行が失敗しました。ステップが報告せずに終わりました。プログラムが終了したか、実行中に Amenbo が再起動しました。",
    "auto.say.maxTimes": "オートメーションの実行が失敗しました。戻る道を、許された回数まで通りました。",
    "auto.say.noAgent": "オートメーションの実行が失敗しました。ステップが求めたエージェントを起動できませんでした。",
    "auto.say.noInput": "オートメーションの実行が失敗しました。ステップの必須の入力が空でした。",
    "auto.say.noWayOn": "オートメーションの実行が失敗しました。次に開くステップがありませんでした。",
    "auto.say.leftTaskOpen": "オートメーションの実行が失敗しました。取ったタスクを閉じずに次へ進もうとしました。",
    "auto.say.halted": "オートメーションの実行が止まり、人を呼んでいます。ステップが、人を呼ぶ出口から出ました。",
    "auto.say.canceled": "オートメーションの実行が中止されました。",
    "auto.say.completed": "オートメーションの実行が完了しました。",
    "auto.say.reached": "「{step}」まで進みました。",
    "auto.say.reachedGone": "今はもう無いステップまで進みました。",
    "auto.say.reachedNothing": "ステップを1つも開かずに止まりました。",
    "auto.say.line": "{why}{reached}（実行 {run}）",
    "auto.say.bi.took": "{task} {title} に着手しました",
    "auto.say.bi.noneToTake": "`{filter}` に合うタスクのうち、着手できるものがありませんでした",
    "auto.say.bi.filed": "{task} {title} を起票しました",
    "auto.say.bi.filedAndTook": "{task} {title} を起票し、着手しました",
    "auto.say.bi.closed": "{task} {title} を完了にしました",
    "auto.say.bi.closedRecorded": "{task} {title} を完了にし、コミット {sha} を記録しました",
    "auto.say.bi.doneAlready": "{task} は既に完了していました",
    "auto.say.bi.rejected": "{task} は却下されています。却下したタスクは完了にしません",
    "auto.say.bi.badSha": "{sha} はコミットの SHA として記録できません。省略しない小文字の16進（SHA-1 は40桁、SHA-256 は64桁）で渡してください。短い SHA・ブランチ・タグ・リビジョンは受け付けません",
    "auto.say.bi.noTaskToClose": "閉じるタスクがありません。この実行はまだタスクを取っていません",
    "auto.say.bi.noTaskToCut": "worktree を切るタスクがありません。この実行はまだタスクを取っていません",
    "auto.say.bi.noTaskToFold": "worktree を畳むタスクがありません。この実行はまだタスクを取っていません",
    "auto.say.bi.noTaskToSplit": "分けるタスクがありません。この実行はまだタスクを取っていません",
    "auto.say.bi.cut": "{from} から、ブランチ {branch} の worktree を {path} に切りました",
    "auto.say.bi.folded": "{path} の worktree とブランチ {branch} を畳みました",
    "auto.say.bi.unmerged": "{branch} には {base} に無い変更があるので、畳まずに残しました",
    "auto.say.bi.noRepository": "このプロジェクトのフォルダは、どれも git リポジトリに入っていません",
    "auto.say.bi.manyRepositories": "このプロジェクトのフォルダが複数のリポジトリにまたがっていて、タスクはそのどれも指していません。どのリポジトリで作業するかが決まりません",
    "auto.say.bi.noGit": "このマシンには git がありません",
    "auto.say.bi.notARepository": "タスクのフォルダがリポジトリに入っていません：{why}",
    "auto.say.bi.worktreeExists": "このタスクの worktree は既に {path} にあります",
    "auto.say.bi.branchExists": "ブランチ {branch} は既にあります。worktree は付いていません",
    "auto.say.bi.noWorktree": "{path} に、このタスクの worktree がありません",
    "auto.say.bi.dirty": "{path} の worktree にコミットしていない変更があるので、畳まずに残しました",
    "auto.say.bi.unquotable": "パス {path} は、どのシェルでも同じに読める形で cd の行に書けません",
    "auto.say.bi.fetched": "{form} {target} から {bytes} バイトを取ってきました",
    "auto.say.bi.gaveNothing": "{form} {target} からは何も返ってきませんでした",
    "auto.say.bi.answered": "{url} が {status} を返しました",
    "auto.say.bi.noFile": "{path} にファイルがありません",
    "auto.say.bi.unanswered": "設定「{setting}」に答えがありません",
    "auto.say.bi.notAForm": "「{form}」は、この組み込みが取りに行ける形式ではありません",
    "auto.say.bi.stillRunning": "`{command}` が {seconds} 秒たっても終わりませんでした",
    "auto.say.bi.exited": "`{command}` が {status} で終わりました：{said}",
    "auto.say.bi.tooLarge": "{from} から返ってきたものが {kib} KiB を超えました",
    "auto.say.bi.notText": "{from} から返ってきたものが UTF-8 のテキストではありません",
    "auto.say.bi.noFolder": "このプロジェクトにはフォルダがありません。コマンドを走らせる場所も、相対パスの起点もありません",
    ...
    "auto.say.bi.fetchFailed": "{url} を取得できませんでした：{error}",
    "auto.say.bi.answeredFailed": "{url} が {status} を返したので、何も取得できませんでした",
    "auto.say.bi.readFailed": "{from} から返ってきた内容を読めませんでした：{error}",
    "auto.say.bi.openFailed": "{path} を開けませんでした：{error}",
    "auto.say.bi.startFailed": "`{command}` を始められませんでした：{error}",
    "auto.say.bi.waitFailed": "`{command}` の終わりを待てませんでした：{error}",
    "auto.say.bi.outsideNotDone": "組み込み「{builtin}」はストアの外で動きますが、ステップを開く前にその作業が済んでいませんでした",
    "auto.say.bi.holdsNotCarried": "組み込み「{builtin}」はステップを開いたまま待つもので、実行するものではありません",
    "auto.say.bi.undeclaredExit": "組み込み「{builtin}」が、このステップに無い出口から出ました",
    ...
    "done.title": "{ref} を完了にする",
    "done.why": "何をやったかを書きます（必須）。報告はタイムラインにコメントとして積まれます。",
    "done.placeholder": "何をやったか",
    "done.confirm": "完了にする", "done.cancel": "やめる",
  ...
  err: {
    ...
    not_ready_automation_entry_takes_no_task: "{step}：起点のステップがタスクを取らないので、その先のステップが何についてのものか決まらない",
    ...
    invalid_make_task_no_runs_task: "「依存させる相手」が「この run が扱っているタスク」ですが、この実行はまだタスクを扱っていません",
