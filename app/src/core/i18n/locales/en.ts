...
const ui = {
  ...
  "auto.place.action": "Which action",
  "auto.place.open": "Open the action's build screen",
  "auto.place.empty": "Nothing is in it yet. It cannot be started until it is built.",
  "auto.place.ownedWhat": "The prompt belongs to the action. It is edited on the action's build screen, and a change there reaches every other placement of it.",
  "auto.place.agents": "Who carries out each step",
  "auto.place.agentsWhat": "Chosen for this spot alone. The same action placed elsewhere is chosen for apart.",
  "auto.place.agentNone": "not chosen",
  "auto.place.agentOf": "Who carries out {step}",
  "auto.place.modelOf": "Model for {step}",
  "auto.place.exitsWhat": "The names and what each hands on are the action's declaration. What is decided here is what happens after each.",
  "auto.start": "Start",
  ...
  "auto.step.name": "Name",
  "auto.step.entry": "A run starts here",
  ...
  "auto.step.taskNotes": "It is handed the task's notes",
  "auto.step.taskDecisions": "It is handed the decisions linked to the task",
  "auto.step.taskComments": "It is handed the comments on the task",
  ...
  "auto.out.title": "Add an output artefact",
  "auto.out.kind": "What it carries",
  "auto.out.add": "Add",
  "auto.step.outputAdd": "＋ Output artefact",
  "auto.step.add": "Add",
  "auto.step.remove": "Remove",
  "auto.step.exitName": "Name of the way out",
  "auto.step.cfgName": "Name of the setting",
  "auto.step.inputName": "Name of the input",
  ...
  "auto.lib.builtin": "Built-in (Amenbo's own)",
  "auto.builtin.readOnly": "A built-in is Amenbo's own, and is not changed. It is here to be read.",
  "auto.builtin.does": "What it does",
  ...
  "auto.bi.takeTask.goOn": "Don’t wait — leave by the way out “No task to take”",
  ...
  "auto.step.nextExit": "End with output “{name}”",
  "auto.pic.actionIn": "Input",
  "auto.pic.actionOut": "Output",
  "auto.pic.actionSelf": "This action",
  "auto.actions.library": "Library",
  "auto.actions.search": "Search names and notes",
  "auto.actions.all": "All",
  "auto.actions.noMatch": "No action matches",
  "auto.actions.pickReach": "— Choose —",
  "auto.actions.makeSaid": "The steps inside and their prompts are written on the build screen, once it is made.",
  "auto.actions.colSteps": "Steps",
  "auto.actions.colUsed": "Used by automations",
  "auto.actions.noSteps": "None yet",
  "auto.actions.usedN": "{n}",
  "auto.actions.usedNone": "None",
  ...
  "auto.act.declaresWhat": "Answered on every automation that places {name}, never here.",
  ...
  "auto.act.noEntry": "No step is opened first. Pick one in a step's contents.",
  "auto.act.entry": "Opened first",
  "auto.act.entryIs": "A placement of this action opens this step",
  "auto.act.entrySet": "Open this step first",
  ...
  "auto.about.id": "ID",
  "auto.about.idWhat": "The number the terminal names it by, as in {command}. It stays the same when the name changes.",
...
const err: Partial<Record<ErrorCode, string>> = {
  ...
  not_ready_automation_no_entry: "no placement is named as the one a run starts on",
  not_ready_automation_action_empty: "the action “{action}” placed on it has no step to start at",
  not_ready_automation_entry_takes_no_task:
    "{step}: the step a run starts on takes no task, so every step after it would be about nothing",
