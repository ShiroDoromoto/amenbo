...
export const id: Translation = {
  ...
  ui: {
    ...
    "settings.automation": "Otomasi",
    "settings.lanes": "Jalur",
    "settings.lanesNote": "Berapa banyak eksekusi otomasi yang boleh berjalan sekaligus. Satu jalur adalah satu terminal yang Anda awasi, dan angkanya berlaku lintas proyek. Menurunkannya tidak menghentikan yang sudah berjalan — peluncuran berikutnya menunggu jalur lebih lama.",
    ...
    "face.lanesHeld": "Jalur otomasi: {held} dari {lanes} terpakai",
    "face.pages": "Halaman",
    "face.page": "Halaman {n}",
    ...
    "auto.block.openExit": "{step}: tidak ada yang ditetapkan setelah {at}.",
    "auto.block.openExitUnnamed": "{step}: tidak ada yang ditetapkan setelahnya.",
    ...
    "auto.pic.fromAction": "dari {action}",
    "auto.pic.unfed": "tidak ada yang sampai ke {names}",
    "auto.pic.hands": "menyerahkan {from} ke {to}",
    "auto.step.none": "Tekan sebuah langkah pada gambar untuk melihat isinya.",
    "auto.step.name": "Nama",
    "auto.step.task": "Tugas yang ditanganinya",
    "auto.step.takesTask": "Di sini ia mengambil tugas berikutnya",
    "auto.step.carriesTask": "Ia mengerjakan tugas yang diambil langkah sebelumnya",
    "auto.step.source": "Apa yang dijalankannya",
    "auto.step.sourceOwn": "Prompt yang ditulis di sini",
    "auto.step.sourceMoves": "Menggantinya ikut membawa keluaran, pengaturan, dan masukan langkah ini.",
    "auto.step.prompt": "Prompt",
    "auto.step.promptFromAction": "Hanya baca — berasal dari {action}. Ubah di tab aksi.",
    "auto.step.raise": "Taruh di pustaka",
    "auto.step.raiseWhat": "Langkah ini lalu menjalankan salinan pustaka, dan jalan keluar, pengaturan serta masukannya ikut pindah.",
    "auto.step.raiseName": "Namanya di pustaka",
    "auto.step.raiseHere": "Proyek ini saja",
    "auto.step.raiseEverywhere": "Semua proyek di komputer ini",
    ...
    "auto.add.title": "Sisipkan sebuah langkah",
  ...
  err: {
    ...
    not_ready_automation_no_steps: "Tidak punya langkah sama sekali",
    not_ready_automation_no_entry: "Tidak ada langkah yang ditetapkan sebagai tempat sebuah jalan dimulai",
