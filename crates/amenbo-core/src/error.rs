...
pub enum ErrorCode {
    ...
    NotReadyAutomationCfgValueClosed,
...
impl ErrorCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            ErrorCode::NotReadyAutomationCfgValueClosed => "not_ready_automation_cfg_value_closed",
    ...
    pub const ALL: &'static [ErrorCode] = &[
        ...
        ErrorCode::NotReadyAutomationCfgValueClosed,
