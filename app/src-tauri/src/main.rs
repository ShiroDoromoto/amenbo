...
fn main() {
  ...
  // process it starts is pointed at a path that is gone.
  amenbo_core::tmpdir::forget_if_gone();

  // Launched as a notification sender rather than as the app (`AMB-D-885`): post what it was handed and
  // exit, without ever reaching the window. It is asked first because everything below it belongs to being
  // an app.
