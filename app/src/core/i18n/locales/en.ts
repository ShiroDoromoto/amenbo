...
const ui = {
  ...
  "auto.act.noEntry": "No step is opened first. Pick one on a step below.",
  ...
  "auto.act.next": "What happens next",
  "auto.act.nextNone": "nothing said yet",
  "auto.act.nextGo": "go on to {step}",
