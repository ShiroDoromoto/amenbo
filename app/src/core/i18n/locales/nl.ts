...
export const nl: Translation = {
  ...
  ui: {
    ...
    "face.composePasses": "Toetsen gaan naar de terminal",
    "face.composeKeeps": "Hier wordt geschreven",
    ...
    "onboard.s2body": "Het afrondingsscherm van het aanmaken — en een bord waar nog niets op staat — openen voor je een terminal in die map. Wil je liever je eigen terminal, dan is hetzelfde verzoek één klik weg, klaar om te plakken.",
