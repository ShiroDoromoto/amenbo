...
//! | v71 | `d7eb482e` | |
//! | v72 | `44287a2e` | |
//! | v73 | `dd05c1d2` | byte-identical to v72 (v73 rewrites words in rows) |
//! | v74 | `5a9d3898` | byte-identical to v73 (v74 names ways out in rows) |
//! | v75 | `4af540af` | |
//! | v76 | `8b81fb22` | |
//! | v77 | `5daaf186` | |
//! | v78 | `610fcf4e` | |
//! | v79 | `9e3a24e9` | |
//! | v80 | `331a15aa` | |
//! | v81 | this commit | byte-identical to v80 (v81 rewrites words in rows); held equal to the live registry below |
//!
...
pub fn frozen(version: i64) -> Option<&'static str> {
    Some(match version {
        ...
        69 => include_str!("schema_frozen/v69.sql"),
        70 => include_str!("schema_frozen/v70.sql"),
        ...
        75 => include_str!("schema_frozen/v75.sql"),
        76 => include_str!("schema_frozen/v76.sql"),
        77 => include_str!("schema_frozen/v77.sql"),
        78 => include_str!("schema_frozen/v78.sql"),
        79 => include_str!("schema_frozen/v79.sql"),
        80 => include_str!("schema_frozen/v80.sql"),
