...
export const vi: Translation = {
  ...
  ui: {
    ...
    "settings.automation": "Tự động hoá",
    "settings.lanes": "Làn",
    "settings.lanesNote": "Bao nhiêu lượt chạy tự động hoá có thể diễn ra cùng lúc. Một làn là một terminal bạn theo dõi, và con số này dùng chung cho mọi dự án. Giảm xuống không dừng thứ đang chạy — lần khởi chạy sau sẽ chờ làn lâu hơn.",
    ...
    "face.lanesHeld": "Làn tự động hoá: {held} trên {lanes} đang dùng",
    "face.pages": "Trang",
    "face.page": "Trang {n}",
    ...
    "auto.block.openExit": "{step}: chưa đặt việc gì sau {at}.",
    "auto.block.openExitUnnamed": "{step}: chưa đặt việc gì tiếp theo.",
    ...
    "auto.pic.fromAction": "từ {action}",
    "auto.pic.unfed": "không có gì đến được {names}",
    "auto.pic.hands": "chuyển {from} sang {to}",
    "auto.step.none": "Nhấn vào một bước trên hình để xem nội dung của nó.",
    "auto.step.name": "Tên",
    "auto.step.task": "Công việc mà nó xử lý",
    "auto.step.takesTask": "Ở đây nó lấy công việc tiếp theo",
    "auto.step.carriesTask": "Nó làm công việc mà bước trước đã lấy",
    "auto.step.source": "Nó chạy cái gì",
    "auto.step.sourceOwn": "Một lời nhắc viết ở đây",
    "auto.step.sourceMoves": "Đổi sẽ mang theo các lối ra, thiết lập và đầu vào của bước này.",
    "auto.step.prompt": "Lời nhắc",
    "auto.step.promptFromAction": "Chỉ đọc — đến từ {action}. Sửa ở thẻ hành động.",
    "auto.step.raise": "Đưa vào thư viện",
    "auto.step.raiseWhat": "Bước này sau đó chạy bản trong thư viện, và các lối ra, thiết lập cùng đầu vào của nó chuyển theo.",
    "auto.step.raiseName": "Tên trong thư viện",
    "auto.step.raiseHere": "Chỉ dự án này",
    "auto.step.raiseEverywhere": "Mọi dự án trên máy này",
  ...
  err: {
    ...
    not_ready_automation_no_steps: "Chưa có bước nào",
    not_ready_automation_no_entry: "Chưa đặt bước nào là nơi một lượt chạy bắt đầu",
