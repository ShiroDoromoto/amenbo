...
export const ja: Translation = {
  ...
  ui: {
    ...
    "act.nTasks.one": "タスク{n}件", "act.nTasks.other": "タスク{n}件",
    "act.nDecisions.one": "決定{n}件", "act.nDecisions.other": "決定{n}件",
    "act.nameless": "（削除済み）",
    "ago.justNow": "たった今",
    "ago.minutes.one": "{n}分前", "ago.minutes.other": "{n}分前",
    "ago.hours.one": "{n}時間前", "ago.hours.other": "{n}時間前",
    "ago.days.one": "{n}日前", "ago.days.other": "{n}日前",
    "due.today": "今日", "due.tomorrow": "明日", "due.yesterday": "昨日",
    "due.inDays.one": "{n}日後", "due.inDays.other": "{n}日後",
    "due.daysAgo.one": "{n}日前", "due.daysAgo.other": "{n}日前",
