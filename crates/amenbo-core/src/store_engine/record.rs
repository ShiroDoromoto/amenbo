    ...
    Record::new(
        ...
        with_audit(
            vec![
                ...
                ("area", tv(s.area.as_str())),
                ("owner_id", kv_opt(&s.owner_id)),
    ...
    Record::new(
        ...
        with_audit(
            vec![
                ...
                ("show_notes", bv(s.show_notes)),
                ("show_decisions", bv(s.show_decisions)),
                ("show_comments", bv(s.show_comments)),
    ...
    Record::new(
        ...
        with_audit(
            vec![
                ...
                ("exit_id", kv(e.exit_id)),
                ("to_id", kv_opt(&e.to_id)),
                ("ends", tv(e.ends.as_str())),
                ("exit_to_id", kv_opt(&e.exit_to_id)),
    ...
    Record::new(
        ...
        with_audit(
            vec![
                ...
                ("from_exit_id", kv_opt(&w.from_exit_id)),
                ("from_port_id", kv(w.from_port_id)),
                ("to_id", kv(w.to_id)),
                ("to_port_id", kv(w.to_port_id)),
            ],
            &w.created_at,
            &w.updated_at,
        ),
    ...
    Record::new(
        ...
        with_audit(
            vec![
                ...
                ("show_notes", bv(d.show_notes)),
                ("show_decisions", bv(d.show_decisions)),
                ("show_comments", bv(d.show_comments)),
                ("exits", tv(&d.exits)),
                ("ins", tv(&d.ins)),
                ("cfg", tv(&d.cfg)),
                ("entry", bv(d.entry)),
    ...
    Record::new(
        ...
        with_audit(
            vec![
                ...
                ("exit_id", kv_opt(&v.exit_id)),
                ("port_id", kv(v.port_id)),
