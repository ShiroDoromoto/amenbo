...
export const vi: Translation = {
  ...
  ui: {
    ...
    "settings.restoreAskNote": "Một thay đổi git chưa ghi lại thì sau khi vứt bỏ không còn ở đâu cả — đây là lần nhấn duy nhất trong cửa sổ này mà không gì hoàn tác được.",
    "git.branches": "Nhánh",
