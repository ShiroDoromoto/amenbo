...
/// is given once, where the action is placed. The agent and the model are the placement's too — chosen
/// there, step by step (`AMB-D-960`). The prompt, the agent, the model and the three flags are
