...
const UI: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    "update.hint": "新しいバージョンが公開されています。最新インストーラ（GUI+CLI 同梱）で更新してください（自動更新はしません）。",
  ...
  en: {
    ...
    "update.hint": "A newer version has been published. Get the latest installer (GUI + CLI together) to update — amenbo does not self-update.",
