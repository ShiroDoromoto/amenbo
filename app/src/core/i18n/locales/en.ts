...
const ui = {
  ...
  "auto.step.name": "Name",
  "auto.step.entry": "Make it the start",
  "auto.step.entryWhat": "One automation has one start.",
  ...
  "auto.act.entryIs": "This step is the start",
  "auto.act.entrySet": "Make it the start",
