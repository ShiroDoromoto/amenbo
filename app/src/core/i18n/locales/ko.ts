...
export const ko: Translation = {
  ...
  ui: {
    ...
    "auto.block.exitWithoutNext": "{step}: {at} 다음에 할 일이 정해지지 않았습니다.",
    "auto.block.exitWithoutNextUnnamed": "{step}: 다음에 할 일이 정해지지 않았습니다.",
    "auto.block.inputUnfed": "{step}: {at}에 아무것도 연결되어 있지 않습니다.",
    "auto.block.agentNotHere": "{step}: 이 컴퓨터에서 {at}을 시작할 수 없습니다.",
    "auto.block.taskUndecided": "실행이 다룰 태스크를 정하는 것이 없습니다.",
    "auto.block.workspaceClosed": "실행을 열 워크스페이스가 없습니다.",
