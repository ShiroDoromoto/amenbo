 ...
 * model at all — for both, the host answers with no road and this is not there. The band it stands
 * in is drawn either way and belongs to the pane rather than to this (`./TerminalPane`): the press
 * beside it opens and shuts the box above, and that one is under every pane (`AMB-D-889`).
 */
