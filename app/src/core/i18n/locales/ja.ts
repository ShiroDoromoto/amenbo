...
export const ja: Translation = {
  ...
  ui: {
    ...
    "auto.place.agents": "エージェント",
    "auto.place.agentNone": "選んでいない",
    "auto.place.agentOf": "{step} のエージェント",
    ...
    "auto.step.placementRemoveConfirm": "この配置を消します。答えた設定と、この配置を指す「次にすること」と受け渡しも一緒に消えます。アクションそのものはライブラリに残ります。戻せません",
    "auto.step.task": "扱っているタスク",
    "auto.step.takesTask": "ここで次のタスクに着手する",
    "auto.step.prompt": "プロンプト",
    "auto.decl.add": "＋ 足す",
    "auto.decl.required": "● 必須",
    "auto.decl.more": "直す・消す",
    "auto.decl.outputAdd": "出力を足す",
    "auto.decl.inputs": "入力",
    "auto.decl.inputName": "入力の名前",
    ...
    "auto.bi.takeTask.does": "絞り込みに合い、着手できる未着手のタスクを並び順どおりに探し、先頭から予約して進行中にする",
    ...
    "auto.bi.makeTask.does": "受け取ったタイトルと本文で、タスクを1件起票する。設定で、起票と同時に進行中にし、この実行で扱える",
    ...
    "auto.bi.makeTask.theRunsTask": "この実行が扱っているタスク",
    ...
    "auto.act.stepRemoveConfirm": "このステップを消しますか？ 入力と出口、このステップを指す「次にすること」と受け渡しも一緒に消えます。元に戻せません",
    "auto.about.name": "名前",
    "auto.about.notes": "メモ",
    "auto.about.cli": "CLI",
    "auto.about.copy": "コピー",
    ...
    "auto.say.leftTaskOpen": "オートメーションの実行が失敗しました。着手したタスクを閉じずに次へ進もうとしました。",
    ...
    "auto.say.bi.noTaskToClose": "閉じるタスクがありません。この実行はまだタスクに着手していません",
    "auto.say.bi.noTaskToCut": "worktree を切るタスクがありません。この実行はまだタスクに着手していません",
    "auto.say.bi.noTaskToFold": "worktree を畳むタスクがありません。この実行はまだタスクに着手していません",
    "auto.say.bi.noTaskToSplit": "分けるタスクがありません。この実行はまだタスクに着手していません",
