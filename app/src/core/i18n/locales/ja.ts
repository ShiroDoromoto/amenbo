...
export const ja: Translation = {
  ...
  ui: {
    ...
    "settings.automation": "オートメーション",
    "settings.lanes": "レーン",
    "settings.lanesNote": "同時に走らせられるオートメーションの実行の数。レーン1つは、あなたが見張るターミナル1つ。数はプロジェクトを跨ぐ。減らしても、走っている実行は止まらない——次の起動がレーンを待つ時間が伸びる。",
    ...
    "face.lanesHeld": "オートメーションのレーン：{lanes} 本のうち {held} 本が使用中",
    "face.pages": "ページ",
    "face.page": "{n} ページ目",
    ...
    "auto.block.openExit": "{step}：終了条件 {at} の次にすることが決まっていない",
    "auto.block.openExitUnnamed": "{step}：次にすることが決まっていない",
    ...
    "auto.pic.fromAction": "{action} から",
    "auto.pic.unfed": "{names} に何も届かない",
    "auto.pic.hands": "{from} を {to} へ渡す",
    "auto.step.none": "図のステップを押すと、中身がここに出ます",
    "auto.step.name": "名前",
    "auto.step.task": "扱っているタスク",
    "auto.step.takesTask": "ここで次のタスクを取る",
    "auto.step.carriesTask": "前のステップが取ったタスクを扱う",
    "auto.step.source": "中身",
    "auto.step.sourceOwn": "ここで書く",
    "auto.step.sourceMoves": "切り替えると、このステップの終了条件・設定・入力パラメータも一緒に移ります",
    "auto.step.prompt": "プロンプト",
    "auto.step.promptFromAction": "読むだけ — {action} から来ています。書き換えるのは「アクション」タブ",
    "auto.step.raise": "ライブラリへ上げる",
    "auto.step.raiseWhat": "上げると、このステップはライブラリの側を走る。終了条件・設定・入力も一緒に移る",
    "auto.step.raiseName": "ライブラリでの名前",
    "auto.step.raiseHere": "このプロジェクトだけ",
    "auto.step.raiseEverywhere": "この端末の全プロジェクト",
    "auto.step.cfg": "設定",
  ...
  err: {
    ...
    not_ready_automation_no_steps: "ステップが1つも無い",
    not_ready_automation_no_entry: "走り出すステップが決まっていない",
