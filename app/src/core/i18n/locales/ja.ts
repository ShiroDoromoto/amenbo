...
export const ja: Translation = {
  ...
  ui: {
    ...
    "agentHook.title": "このフォルダの AI を amenbo から始めますか？",
    "agentHook.why": "お使いのツールのセッション開始フックを使うと、このフォルダの AI に毎回 amenbo の指示を読ませられます。管理ブロックが読まれなかったときでも取りこぼしません。",
    "agentHook.again": "以前「はい」と答えていますが、ここではまだ AI が amenbo から始まりません。テキストが貼られていないか、クローンに付いてこなかったようです。",
    "agentHook.where": "{project} — {dir}",
    "agentHook.noWrite": "amenbo は設定ファイルを書きません。テキストをお渡ししますので、貼るのはご自身でお願いします。",
    "agentHook.looksLike": "このフォルダは {tool} のもののようです。",
    "agentHook.yes": "はい、テキストをください",
    "agentHook.no": "いいえ",
    "agentHook.scope": "このプロジェクトで訊くのはこの1回だけです。",
    ...
    "agentHookSetup.unwired": "{tool}: セッション開始時に `{cmd}` を実行していません。{file} に貼ってください。",
