...
export const ko: Translation = {
  ...
  ui: {
    ...
    "settings.automation": "오토메이션",
    "settings.lanes": "레인",
    "settings.lanesNote": "한 번에 진행할 수 있는 오토메이션 실행 수. 레인 하나는 지켜보는 터미널 하나이며, 이 수는 프로젝트를 가로지른다. 줄여도 이미 돌고 있는 실행은 멈추지 않는다 — 다음 실행이 레인을 더 오래 기다린다.",
    ...
    "face.lanesHeld": "오토메이션 레인: {lanes}개 중 {held}개 사용 중",
    "face.pages": "페이지",
    "face.page": "{n}페이지",
    ...
    "auto.block.openExit": "{step}: {at} 다음에 할 일이 정해지지 않았습니다.",
    "auto.block.openExitUnnamed": "{step}: 다음에 할 일이 정해지지 않았습니다.",
    ...
    "auto.pic.fromAction": "{action}에서",
    "auto.pic.unfed": "{names}에 아무것도 닿지 않습니다",
    "auto.pic.hands": "{from}을(를) {to}(으)로 넘깁니다",
    "auto.step.none": "그림에서 단계를 누르면 내용이 여기에 나옵니다.",
    "auto.step.name": "이름",
    "auto.step.task": "다루는 작업",
    "auto.step.takesTask": "여기에서 다음 작업을 가져옵니다",
    "auto.step.carriesTask": "앞 단계가 가져온 작업을 다룹니다",
    "auto.step.source": "내용",
    "auto.step.sourceOwn": "여기에 프롬프트를 씁니다",
    "auto.step.sourceMoves": "바꾸면 이 단계의 출구·설정·입력도 함께 옮겨집니다.",
    "auto.step.prompt": "프롬프트",
    "auto.step.promptFromAction": "읽기 전용 — {action}에서 왔습니다. 고치려면 '액션' 탭에서.",
    "auto.step.raise": "라이브러리에 올리기",
    "auto.step.raiseWhat": "올리면 이 단계는 라이브러리 쪽을 실행하고, 종료 조건·설정·입력도 함께 옮겨집니다.",
    "auto.step.raiseName": "라이브러리에서의 이름",
    "auto.step.raiseHere": "이 프로젝트만",
    "auto.step.raiseEverywhere": "이 컴퓨터의 모든 프로젝트",
    "auto.step.cfg": "설정",
  ...
  err: {
    ...
    not_ready_automation_no_steps: "스텝이 하나도 없습니다",
    not_ready_automation_no_entry: "실행이 시작될 스텝이 정해져 있지 않습니다",
