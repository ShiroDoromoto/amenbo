...
const ui = {
  ...
  "auto.block.openExit": "{step}: nothing is set to happen after {at}.",
  "auto.block.openExitUnnamed": "{step}: nothing is set to happen after it.",
  ...
  "auto.step.raise": "Put it in the library",
  "auto.step.raiseWhat": "The step then runs the library's copy, and its ways out, settings and inputs go with it.",
  "auto.step.raiseName": "What to call it in the library",
  "auto.step.raiseHere": "This project only",
  "auto.step.raiseEverywhere": "Every project on this computer",
