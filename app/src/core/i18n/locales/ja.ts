...
export const ja: Translation = {
  ...
  ui: {
    ...
    "auto.step.name": "名前",
    "auto.step.entry": "起点にする",
    "auto.step.entryWhat": "起点は、1本のオートメーションに1つ",
    ...
    "auto.act.stepsHint": "上の「受け取る」から入り、ステップを通って、下の「出口」のどれかで終わる",
    ...
    "auto.act.noEntry": "起点のステップが決まっていません。ステップの中身で選んでください",
