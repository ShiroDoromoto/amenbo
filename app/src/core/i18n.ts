...
const UI: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    "restart.stuck.command": "amenbo restore <移行前バックアップ (.amenbo-backup)>",
    ...
    "plugins.layer.official": "公式", "plugins.layer.listed": "掲載", "plugins.layer.third-party": "目録外",
    "plugins.sort": "並べ替え", "plugins.sort.new": "新着", "plugins.sort.name": "名前",
    "plugins.added": "追加 {date}",
    "plugins.sources": "目録 {count}", "plugins.offered": "{count} 件",
    "plugins.sourceDown": "接続できません", "plugins.addSource": "追加", "plugins.removeSource": "解除",
    "plugins.sourcePh": "目録の catalog.json の URL（https://…）",
    "plugins.sourcesNote": "目録を足すと一覧に出るものが増えます。入れられるかどうかは変わりません（署名は amenbo の鍵のみ）。",
    "plugins.count": "{shown} / {total} 件",
    "plugins.loading": "目録を読み込み中…",
    "plugins.emptyCatalog": "掲載されているプラグインはまだありません",
    "plugins.emptyFilter": "条件に合うプラグインがありません",
    "plugins.unreachable": "{count} 件の目録に接続できませんでした（一覧はその分欠けています）",
    "plugins.error": "目録を読み込めませんでした",
    "plugins.dropped": "{count} 件は目録の検証に通らず一覧に出ていません",
    "plugins.close": "閉じる",
    "plugins.openRepo": "GitHub で開く（{repo}）",
    "plugins.downloads": "⬇ {count}",
    "plugins.factsLoading": "GitHub から取得中…",
    "plugins.factsError": "GitHub から読めませんでした（目録の情報だけ表示しています）",
    "plugins.rateLimited": "GitHub の回数制限に達しました。しばらく待つと取得できます。",
    "plugins.noReadme": "README はありません",
    "plugins.factsNote": "★・ダウンロード数・README は、開いたこの1件だけを GitHub から取得しています（目録には入っていません）。数字は目安で、入れられるかどうかとは関係ありません。",
  ...
  en: {
    ...
    "restart.stuck.command": "amenbo restore <pre-migration backup (.amenbo-backup)>",
    ...
    "plugins.sort": "Sort", "plugins.sort.new": "Newest", "plugins.sort.name": "Name",
    ...
    "plugins.sourcesNote": "Adding a catalog widens what you see here, not what can be installed (assets are trusted by amenbo's key alone).",
