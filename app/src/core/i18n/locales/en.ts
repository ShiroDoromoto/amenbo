...
const ui = {
  ...
  "agentHook.title": "Start this folder's AI on amenbo?",
  "agentHook.why": "amenbo can have this folder's AI read its instruction at the start of every session, through your tool's own session-start hook — so it arrives even when the managed block is not read.",
  "agentHook.again": "You said yes to this before, and nothing here starts the AI on amenbo yet — the text may not have been pasted, or a clone did not carry it.",
  "agentHook.where": "{project} — {dir}",
  "agentHook.noWrite": "amenbo writes no settings file: it hands you the text, and you paste it.",
  "agentHook.looksLike": "This folder looks like {tool}'s.",
  "agentHook.yes": "Yes, give me the text",
  "agentHook.no": "No",
  "agentHook.scope": "Asked once for this project.",
  "agentHook.scopeAgain": "amenbo will not ask a third time.",
  ...
  "agentHookSetup.unwired": "{tool}: does not run `{cmd}` at session start. Paste the text into {file}.",
