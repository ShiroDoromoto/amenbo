...
const PAIRINGS: &[(&str, &str, f64)] = &[
    ...
    ("c-on-ai", "c-ai", TEXT),
    ("c-ai", "c-ai-weak", TEXT),
    ("c-stop", "c-stop-weak", TEXT),
    ("c-heed", "c-heed-weak", TEXT),
...
const ABOUT: &[(&str, &str)] = &[
    ...
    ("c-ai", "the AI facet"),
    ("c-ai-weak", "a wash of the AI facet, for the ground of a run's header"),
    ("c-bg", "the page"),
    ...
    ("c-stop-weak", "a wash of stop, for the ground of a band saying a run failed"),
