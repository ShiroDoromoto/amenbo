...
const UI: Record<Lang, Record<string, string>> = {
  ja: {
    ...
    "hookForeign.title": "他のツールのフックには、amenbo は触っていません",
    "hookForeign.slot": "{slot} は他のツールのものです。そこでも弾くなら、この1行をご自身で足してください: {line}",
  ...
  en: {
    ...
    "hookForeign.title": "amenbo left another tool's hooks alone",
    "hookForeign.slot": "{slot} belongs to another tool. To lint there too, add this line yourself: {line}",
