...
.PHONY: help install install-dev gui gui-dev install-gui install-gui-dev dev-build hooks verify lint-linux verify-gui-linux verify-network-linux verify-network-mac test doc-gate shell-gate comment-gate go-gate sweep-stale dist-gui dist-gui-mac dist-gui-linux verify-existing-store release codesign-cert devtool
