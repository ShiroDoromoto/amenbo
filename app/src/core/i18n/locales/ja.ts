...
export const ja: Translation = {
  ...
  ui: {
    ...
    "auto.step.sort.due": "期日の近い順",
    "auto.step.sort.created": "作成日の古い順",
    "auto.kind.value": "値",
    "auto.kind.file": "ファイル",
    ...
    "auto.say.maxTimes": "オートメーションの実行が失敗しました。戻る線を、繰り返しの上限まで通りました。",
