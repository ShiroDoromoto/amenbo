...
const ui = {
  ...
  "mcp.title": "Reach this project from an AI",
  "mcp.open": "Connect over MCP (for an AI that cannot open a folder)",
  "mcp.hint": "Your AI reaches this project through a server bound to its folder. Set it up once per project, in whichever app you use.",
