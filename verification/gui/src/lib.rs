...
impl Instructor {
    ...
    ///
    /// `ai-launch-answer` is the third of them and a `Review`: all three of its answers — the yes, the
    /// no, and the never asked — are drawn as words of the interface, and which of them is standing is
    /// not something the presence of text can settle.
    ///
    ...
    ///
    /// `tick setting` is a `Review` for the reason `ai-launch-answer` is: the two positions the row
    ...
    fn action(&self, domain: Domain, op: &str, with: &Args) -> Result<String, String> {
        Ok(match (domain, op) {
            ...
            (Domain::Files, "stash") => "In the half of the panel that is git's, press the last of the buttons under the line naming the branch: a list comes up. At the top of it, press the row that offers to put the changes aside. The list goes.".to_string(),
            ...
            (Domain::Files, "stash-list") => "In the half of the panel that is git's, press the last of the buttons under the line naming the branch: a list comes up. Leave it standing.".to_string(),
            ...
            (Domain::Files, "stash-restore") => format!(
                "In the half of the panel that is git's, press the last of the buttons under the line naming the branch to bring the list of what is put aside up. Press the row whose line carries \"{}\". The list goes.",
                req(with, "shows")?
            ),
    ...
    fn assert(&self, domain: Domain, op: &str, with: &Args) -> Result<String, String> {
        Ok(match (domain, op) {
            ...
            // section draws none of the three fields setup leaves behind — what stands there instead
            // is a sentence saying the press writes them and there is nothing to fill in.
