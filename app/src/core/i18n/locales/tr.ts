...
export const tr: Translation = {
  ...
  ui: {
    ...
    "settings.automation": "Otomasyonlar",
    "settings.lanes": "Şeritler",
    "settings.lanesNote": "Aynı anda kaç otomasyon çalıştırması sürebilir. Bir şerit, izlediğiniz bir terminaldir ve sayı projeler arasında ortaktır. Düşürmek çalışmakta olan hiçbir şeyi durdurmaz — sonraki başlatma şerit için daha uzun bekler.",
    ...
    "face.lanesHeld": "Otomasyon şeritleri: {lanes} şeritten {held} tanesi kullanımda",
    "face.pages": "Sayfalar",
    "face.page": "Sayfa {n}",
    ...
    "auto.block.openExit": "{step}: {at} sonrasında ne olacağı belli değil.",
    "auto.block.openExitUnnamed": "{step}: sonrasında ne olacağı belli değil.",
    ...
    "auto.pic.fromAction": "{action} kaynaklı",
    "auto.pic.unfed": "{names} girdisine hiçbir şey ulaşmıyor",
    "auto.pic.hands": "{from} değerini {to} girdisine verir",
    "auto.step.none": "İçeriğini görmek için şemadaki bir adıma basın.",
    "auto.step.name": "Ad",
    "auto.step.task": "İlgilendiği görev",
    "auto.step.takesTask": "Sıradaki görevi burada alır",
    "auto.step.carriesTask": "Önceki bir adımın aldığı görev üzerinde çalışır",
    "auto.step.source": "Ne çalıştırdığı",
    "auto.step.sourceOwn": "Burada yazılmış bir istem",
    "auto.step.sourceMoves": "Değiştirmek bu adımın çıkışlarını, ayarlarını ve girdilerini de götürür.",
    "auto.step.prompt": "İstem",
    "auto.step.promptFromAction": "Salt okunur — {action} kaynaklı. Değiştirmek için eylemler sekmesine gidin.",
    "auto.step.raise": "Kitaplığa koy",
    "auto.step.raiseWhat": "Adım bundan sonra kitaplıktaki kopyayı çalıştırır; çıkışları, ayarları ve girdileri de onunla taşınır.",
    "auto.step.raiseName": "Kitaplıktaki adı",
    "auto.step.raiseHere": "Yalnızca bu proje",
    "auto.step.raiseEverywhere": "Bu bilgisayardaki tüm projeler",
  ...
  err: {
    ...
    not_ready_automation_no_steps: "Hiç adımı yok",
    not_ready_automation_no_entry: "Bir çalışmanın başlayacağı adım belirlenmemiş",
