...
export const id: Translation = {
  ...
  ui: {
    ...
    "settings.restoreAskNote": "Perubahan yang belum dicatat git tidak ada di mana pun setelah dibuang — satu-satunya tekanan di jendela ini yang tidak bisa dibatalkan.",
    "git.branches": "Branch",
