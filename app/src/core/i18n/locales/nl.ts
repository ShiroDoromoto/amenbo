...
export const nl: Translation = {
  ...
  ui: {
    ...
    "search.filterPhNone": "Deze soort neemt geen filter",
    "search.kind": "Soort",
    "search.kindAll": "Alle",
    "search.kind.task": "Taken",
    "search.kind.decision": "Besluiten",
    "search.kind.automation": "Automatiseringen",
    ...
    "search.on.automation": "Automatisering",
    ...
    "auto.act.noEntry": "Er is geen stap die als eerste opent. Kies er hieronder een.",
