 ...
 * same way wherever it arrives; the four the file panel meets when it writes a name into a folder
 ...
 * (`folder_make`, `folder_rename`); and the two it answers a save with (`crate::folder_save`) — a
