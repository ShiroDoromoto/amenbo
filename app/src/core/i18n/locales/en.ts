...
const ui = {
  ...
  "auto.place.ownedWhat": "The prompt and who carries it out belong to the action. They are edited on the action's build screen, and a change there reaches every other placement of it.",
