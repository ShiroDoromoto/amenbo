...
export const id: Translation = {
  ...
  ui: {
    ...
    "onboard.s2body": "Layar selesai membuat — dan papan yang masih kosong — membuka terminal di folder itu untuk Anda. Jika Anda lebih suka milik sendiri, permintaan yang sama hanya sekali klik, siap ditempel.",
