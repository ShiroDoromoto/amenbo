...
export const ja: Translation = {
  ...
  ui: {
    ...
    "notify.event.decision.accepted": "決定が採択された",
    ...
    "nav.decisions": "決定記録", "nav.mcp": "MCP でつなぐ", "nav.search": "検索",
    "dec.title": "決定記録",
    ...
    "dimmgr.appliesTo.decision": "決定記録",
    ...
    "settings.tickOn": "オン",
    "settings.tickOff": "オフ",
    "settings.tickNote": "オンにすると、この端末のスケジューラが1時間に1度 Amenbo を起こします。Amenbo は期日の近いタスクを探し、有効にしているプラグインから知らせを届けます。オフにすると登録を取り去るので、裏で動き続けるものは残りません。",
    ...
    "search.on.decisionComment": "決定記録へのコメント",
    ...
    "plugins.want.settings": "入れたあとに設定するもの:", "plugins.want.secret": "シークレット",
    ...
    "plugins.cfg.secretNote": "シークレットはこのプロジェクトに保存し、あとから表示することはできません。",
    "plugins.cfg.secretNoteDevice": "シークレットはこの端末に保存し、あとから表示することはできません。",
    ...
    "plugins.check.refused": "プラグイン自身の検査を通らない設定なので、有効にしていません。",
    "plugins.check.noAnswer": "プラグイン自身の検査から返事が無かったので、有効にしていません。何が起きたかは実行ログに残っています。",
    ...
    "plugins.updates.catalog.cached": "カタログ: 通信せず、保存済みのキャッシュが答えました（{ago}）",
    "plugins.updates.catalog.offline": "カタログ: 接続できず、保存済みのキャッシュが答えました（{ago}）",
    "plugins.updates.catalog.unavailable": "カタログ: どれも答えませんでした — 取得もキャッシュもないので、ここに出ているものは判定ではありません",
    ...
    "plugins.removeConfirm": "「{name}」を削除しますか？ 本体だけでなく、全プロジェクトの設定・シークレット・許可の記録も削除されます。入れ直しても戻りません。",
    ...
    "plugins.removedPart.secrets": "シークレット",
    ...
    "face.paneDown": "上下に並べる",
    "face.panes.other": "{n}枚",
    "face.pages": "ページ",
    "face.page": "{n} ページ目",
    "face.order": "ペインを並べ替える",
    "face.orderTitle": "ペインの並べ替え",
    ...
    "tickBanner.what": "1時間に1度 Amenbo が起きて、期日の近いタスクを探し、有効にしているプラグインから知らせを届けます。起こすのはこの端末のスケジューラなので、裏で動き続けるものはありません。",
    ...
    "notify.say.subject.decisionAccepted": "決定を採択",
  ...
  err: {
    ...
    not_ready_premise_unsettled: "{ref} が未確定です。裁定を待つかリンクを外してください",
    ...
    not_found_plugin_build_source_silent: "「{name}」は {url} から入れましたが、そのカタログは応答せず、キャッシュもありません。バージョンを突き合わせられません。",
    ...
    invalid_catalog_version_ahead: "このカタログはバージョン {version} で、この Amenbo が読めるバージョン（{supported}）より新しいです。Amenbo を更新してください。",
