...
export const nl: Translation = {
  ...
  ui: {
    ...
    "settings.restoreAskNote": "Een wijziging die git niet heeft vastgelegd is nergens meer zodra ze is weggegooid — de enige druk in dit venster die niets ongedaan maakt.",
