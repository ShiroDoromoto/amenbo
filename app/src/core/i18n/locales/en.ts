...
const ui = {
  ...
  "settings.skinHow": "A skin is one file: a zip holding `skin.yaml` and its materials, or that document on its own. Take one in with `amenbo skin add <file>` in a terminal.",
  ...
  "settings.skinAddDrop": "or drop a .zip or .yaml here",
