...
const ui = {
  ...
  "auto.place.agentOf": "The agent for {step}",
  ...
  "auto.step.placementRemoveConfirm": "This takes the placement off, with the settings answered on it and every “what happens next” and handoff naming it. The action itself stays in the library. It cannot be undone.",
  ...
  "auto.decl.outputAdd": "Add an output",
  "auto.decl.inputs": "Inputs",
  "auto.decl.inputName": "Name of the input",
  ...
  "auto.step.folder": "Working folder",
  ...
  "auto.step.sort.created": "by creation date, oldest first",
  ...
  "auto.bi.takeTask.does": "Looks for the tasks the filter matches that are not started and can be taken, in the order it sets, and reserves the first it can, moving it to in progress",
  ...
  "auto.bi.makeTask.name": "File a task",
  "auto.bi.makeTask.does": "Files one task from the title and notes it is handed. Set to, it moves the task to in progress as it files it, and this run works it",
  "auto.bi.makeTask.whatThen": "The filed task",
  "auto.bi.makeTask.leaveIt": "Leave it not started — leave by the exit “Filed”",
  "auto.bi.makeTask.takeIt": "Move it to in progress — leave by the exit “Filed and taken”",
  "auto.bi.makeTask.dependsOn": "Depends on",
  "auto.bi.makeTask.theRunsTask": "The task this run is working",
  "auto.bi.makeTask.classify": "Classification",
  "auto.bi.makeTask.aiAxes": "Axes the AI chooses on",
  "auto.bi.makeTask.assignee": "Assignee",
  "auto.bi.makeTask.priority": "Priority",
  "auto.bi.makeTask.none": "None",
  "auto.bi.makeTask.human": "Person",
  "auto.bi.makeTask.ai": "AI",
  "auto.bi.makeTask.high": "High",
  "auto.bi.makeTask.medium": "Medium",
  "auto.bi.makeTask.low": "Low",
  "auto.bi.makeTask.title": "Title",
  "auto.bi.makeTask.notes": "Notes",
  "auto.bi.makeTask.chosen": "Chosen classification",
  "auto.bi.makeTask.made": "Filed",
  "auto.bi.makeTask.madeAndTaken": "Filed and taken",
  "auto.bi.makeTask.task": "Task",
  "auto.bi.makeTask.dependsOnTasks": "Existing tasks it depends on",
  "auto.bi.makeTask.decisions": "Decisions to link",
  "auto.bi.makeTask.folder": "Working folder",
  ...
  "auto.bi.fetch.name": "Fetch",
  "auto.bi.fetch.does": "Looks at the place set (a URL, a file path or a command) and hands on what it brought back. If there is nothing there, it leaves by “Not found”",
  "auto.bi.fetch.form": "Form",
  "auto.bi.fetch.url": "URL",
  "auto.bi.fetch.filePath": "File path",
  "auto.bi.fetch.command": "Command",
  "auto.bi.fetch.target": "Where to look",
  "auto.bi.fetch.fetched": "Fetched",
  "auto.bi.fetch.content": "Content",
  "auto.bi.fetch.notFound": "Not found",
  "auto.bi.splitByDim.name": "Split by category",
  "auto.bi.splitByDim.does": "Sends the task in hand down the way out named by its value on the chosen axis. Each value has a way out, and a task with no value leaves by “Unsorted”",
  "auto.bi.splitByDim.unsorted": "Unsorted",
  "auto.bi.wait.name": "Wait",
  "auto.bi.wait.does": "Waits for the time set, then goes out by “Done”",
  "auto.bi.wait.hours": "Hours",
  "auto.bi.wait.minutes": "Minutes",
  "auto.bi.wait.seconds": "Seconds",
  "auto.bi.wait.done": "Done",
  ...
  "auto.act.stepRemoveConfirm": "Delete this step? Its inputs and ways out, and every “what happens next” and handoff naming it, go with it. This cannot be undone.",
  ...
  "auto.say.crashed": "An automation run failed: a step ended without reporting — its program exited, or Amenbo was restarted while it was under way.",
  "auto.say.maxTimes": "An automation run failed: a way back was taken as many times as its limit allows.",
  "auto.say.noAgent": "An automation run failed: the agent a step asked for could not be started.",
  ...
  "auto.say.reached": "It got as far as \"{step}\".",
  "auto.say.reachedGone": "It got as far as a step that is no longer there.",
  "auto.say.reachedNothing": "It stopped before opening a step.",
  "auto.say.line": "{why} {reached} (run {run})",
  "auto.say.bi.took": "took {task} {title}",
  "auto.say.bi.noneToTake": "no task `{filter}` lists could be taken",
  "auto.say.bi.filed": "filed {task} {title}",
  "auto.say.bi.filedAndTook": "filed and took {task} {title}",
  "auto.say.bi.closed": "closed {task} {title}",
  "auto.say.bi.closedRecorded": "closed {task} {title}, recorded {sha}",
  "auto.say.bi.doneAlready": "{task} was done already",
  "auto.say.bi.rejected": "{task} was decided against, and a task decided against is not closed as done",
  "auto.say.bi.badSha": "{sha} is not a commit sha to record: it must be full-length lower-case hex (40 for SHA-1, 64 for SHA-256) — not a short sha, branch, tag or revision",
  "auto.say.bi.noTaskToClose": "there is no task to close — the run has not taken one",
  "auto.say.bi.noTaskToCut": "there is no task to cut a worktree for — the run has not taken one",
  "auto.say.bi.noTaskToFold": "there is no task whose worktree to fold — the run has not taken one",
  "auto.say.bi.noTaskToSplit": "there is no task to split — the run has not taken one",
  "auto.say.bi.cut": "cut {path} on {branch} from {from}",
  "auto.say.bi.folded": "folded {path} and {branch}",
  "auto.say.bi.unmerged": "{branch} carries changes {base} does not have, so it was left standing",
  "auto.say.bi.noRepository": "no folder of this project is in a git repository",
  "auto.say.bi.manyRepositories": "this project's folders are in more than one repository, and the task names none of them — which one to work in is not written anywhere",
  "auto.say.bi.noGit": "there is no git on this machine",
  "auto.say.bi.notARepository": "the task's folder is in no repository: {why}",
  "auto.say.bi.worktreeExists": "a worktree for this task is standing already at {path}",
  "auto.say.bi.branchExists": "the branch {branch} is there already, with no worktree on it",
  "auto.say.bi.noWorktree": "there is no worktree for this task at {path}",
  "auto.say.bi.dirty": "the worktree at {path} carries changes nobody has committed, so it was left standing",
  "auto.say.bi.unquotable": "the path {path} cannot be written into a cd line that every shell reads alike",
  "auto.say.bi.fetched": "fetched {bytes} bytes from {form} {target}",
  "auto.say.bi.gaveNothing": "{form} {target} gave back nothing",
  "auto.say.bi.answered": "{url} answered {status}",
  "auto.say.bi.noFile": "there is no file at {path}",
  "auto.say.bi.unanswered": "the setting '{setting}' is unanswered",
  "auto.say.bi.notAForm": "'{form}' is not a form this built-in fetches from",
  "auto.say.bi.stillRunning": "`{command}` was still running after {seconds}s",
  "auto.say.bi.exited": "`{command}` exited with {status}: {said}",
  "auto.say.bi.tooLarge": "{from} gave back more than {kib} KiB",
  "auto.say.bi.notText": "what {from} gave back is not UTF-8 text",
  "auto.say.bi.noFolder": "this project has no folder, so there is nowhere to run a command or read a relative path from",
  ...
  "auto.say.bi.fetchFailed": "could not fetch {url}: {error}",
  "auto.say.bi.answeredFailed": "{url} answered {status}, so nothing was fetched",
  "auto.say.bi.readFailed": "could not read what {from} gave back: {error}",
  "auto.say.bi.openFailed": "could not open {path}: {error}",
  "auto.say.bi.startFailed": "could not start `{command}`: {error}",
  "auto.say.bi.waitFailed": "could not wait for `{command}` to finish: {error}",
  "auto.say.bi.outsideNotDone": "the built-in '{builtin}' works outside the store, and that was not done before its step was opened",
  "auto.say.bi.holdsNotCarried": "the built-in '{builtin}' holds its step open, and is not carried out",
  "auto.say.bi.undeclaredExit": "the built-in '{builtin}' left by a way out this step does not declare",
