...
- **A goal both the CLI and the screen can reach is one file**, naming both drivers. A goal only one
...
set carries the paths thickly; a GUI line costs a screenshot, an OCR pass and a
