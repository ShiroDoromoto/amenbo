 ...
 */
export function TrashAsk({ name, onGo, onCancel }: {
  /** The row about to go, as the reader sees it named. */
  name: string;
  ...
  return createPortal(
    ...
    >
      <div className="trashask" role="dialog" aria-modal="true" aria-labelledby="trashask-title">
        <div className="trashask__title" id="trashask-title">{tf("files.trashAsk", { name })}</div>
