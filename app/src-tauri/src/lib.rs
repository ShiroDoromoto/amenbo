...
pub fn run() {
  ...
  builder
    ...
    .setup(|app| {
      ...
      // the run that first has no use for it, and after that there is nothing to find.
      if let Ok(paths) = amenbo_core::config::Paths::resolve() {
        let _ = std::fs::remove_dir_all(paths.base_dir.join("sessions"));
      }
    ...
    .invoke_handler(tauri::generate_handler![
      ...
      automation::automation_step_add,
      automation::automation_step_remove,
      automation::automation_action_step_insert,
      automation::automation_action_entry_set,
      automation::automation_action_detail,
      automation::automation_edge_set,
      automation::automation_edge_clear,
      ...
      automation::automation_cfg_declare,
      automation::automation_cfg_edit,
      automation::automation_cfg_remove,
      automation::automation_input_declare,
      automation::automation_input_edit,
      automation::automation_input_remove,
      automation::automation_wire_set,
      ...
      commands::notify_targets,
      commands::notify_target_add,
      ...
      agent_models::agent_default_model,
      frames::frame_names,
      ...
      folder_git_write::folder_git_take,
