...
CREATE TABLE IF NOT EXISTS decision_edge (
    id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    decision_id BIGINT NOT NULL DEFAULT 0 REFERENCES decision(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    target_decision_id BIGINT NOT NULL DEFAULT 0 REFERENCES decision(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
...
CREATE TABLE IF NOT EXISTS decision_task_link (
    id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    decision_id BIGINT NOT NULL DEFAULT 0 REFERENCES decision(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    task_id BIGINT NOT NULL DEFAULT 0 REFERENCES task(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    created_at TEXT NOT NULL DEFAULT '' CHECK(created_at = '' OR created_at GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9]Z'),
    updated_at TEXT NOT NULL DEFAULT '' CHECK(updated_at = '' OR updated_at GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9]Z')
);
...
CREATE TABLE IF NOT EXISTS task_dependency (
    id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    task_id BIGINT NOT NULL DEFAULT 0 REFERENCES task(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    blocked_by_id BIGINT NOT NULL DEFAULT 0 REFERENCES task(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    created_by_kind TEXT CHECK(created_by_kind IN ('human', 'ai')),
    created_at TEXT NOT NULL DEFAULT '' CHECK(created_at = '' OR created_at GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9]Z'),
    updated_at TEXT NOT NULL DEFAULT '' CHECK(updated_at = '' OR updated_at GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9]Z')
);
...
CREATE TABLE IF NOT EXISTS dimension_value (
    id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL,
    dimension_id BIGINT NOT NULL DEFAULT 0 REFERENCES dimension(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    name TEXT NOT NULL DEFAULT '',
    order_key TEXT NOT NULL DEFAULT '',
    start_on TEXT CHECK(start_on GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]'),
...
CREATE TABLE IF NOT EXISTS task_dimension_value (
    ...
    task_id BIGINT NOT NULL DEFAULT 0 REFERENCES task(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    dimension_id BIGINT NOT NULL DEFAULT 0 REFERENCES dimension(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    value_id BIGINT NOT NULL DEFAULT 0 REFERENCES dimension_value(id) ON DELETE CASCADE ON UPDATE CASCADE DEFERRABLE INITIALLY DEFERRED,
    created_at TEXT NOT NULL DEFAULT '' CHECK(created_at = '' OR created_at GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9]Z'),
    updated_at TEXT NOT NULL DEFAULT '' CHECK(updated_at = '' OR updated_at GLOB '[0-9][0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9]T[0-9][0-9]:[0-9][0-9]:[0-9][0-9]Z')
);
...
CREATE TABLE IF NOT EXISTS hook_consent (
    project_id INTEGER PRIMARY KEY REFERENCES project(id) ON DELETE CASCADE NOT NULL,
    answer     TEXT CHECK (answer IN ('yes', 'no')) NOT NULL
);
